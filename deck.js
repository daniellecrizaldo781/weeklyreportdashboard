...
/* =====================================================================
   SLIDE 1 — Weekly Sales & Business Overview  (SALES first & prominent)
   ===================================================================== */
function s1(){
  ...
  return slide(1, 'Weekly Sales & Business Overview',
    'How did we perform this week?'+(sPrev!=null?'  ·  Compared to '+weeks[weeks[sel].prev].label+' ('+money(sPrev)+')':''),
    sec);
}
